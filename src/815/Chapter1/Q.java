...
2. Which of the following are true? (Choose all that apply.) // Java puts source code in .java files and bytecode in .class files
    ...
    D. java accepts the name of the class as a parameter.       (Correct) // When running a Java program, you pass just the name of the class without the .class extension.
...
// To use this launcher, programs can only reference classes built into the JDK
    ...
    C. MyProgram can reference classes in the package java.lang.        (Correct)
    D. MyProgram can reference classes in the package java.util.        (Correct)
...
E. public static void main(String[] args)   (Correct)
